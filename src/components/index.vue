...
<div class="warp">
    <div class="main">
        <div class="index-button">
            <a v-on:click="newCustomerDialog" class="clearStorage" href="javascript:void(0);">新客获取向导</a>
            <a v-on:click="crowdUpDialog" class="clearStorage" href="javascript:void(0);">存量营销向导</a>
        </div>
    ...
    <div class="dialog" id="new_customer"
        ...
        <div class="dialog-body">
            <div class="dialog-bugButton">
                <a href="/filter/index.html"><i class="icon01"></i><span>标签筛选</span></a>
                <router-link to="models"><i class="icon02"></i><span>建模筛选</span></router-link>
            </div>
        </div>
    </div>
</div>
